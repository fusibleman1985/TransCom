...
public interface UserMapper2 {
    ...
    User toUser(UserDtoRequest userDtoRequest, @Context UtilsUser utilsUser);

    @Mapping(target = "uuid", source = "id")
//    @Mapping(target = "phoneNumbers", source = "phones", qualifiedByName = "mapPhonesToPhoneNumbers")
    ...
    @Mapping(target = "updatedAt", ignore = true)
    @Mapping(target = "password", ignore = true)
//    @Mapping(target = "phones", source = "phoneNumbers", qualifiedByName = "mapPhoneNumbersToPhones")
    @Mapping(target = "phones", expression = "java(mapPhoneNumbersToPhones(userDtoRequest.getPhoneNumbers(), user))")
